...
% 
% Inputs:
% a: vector of proximal attachment points in {F} on the form
%    a   =   | a1_x ... am_x |
%            | a1_y ... am:y |
%
% b: vector of distal attachment points in {P} on the form 
%    b   =   | b1_x ... bm_x |
%            | b1_y ... bm:y |
%
% y: vector with pose of the platform in {F} containg the carthesian
